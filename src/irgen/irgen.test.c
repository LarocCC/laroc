...
int main() {
  ...
  assert(arrlen(mod->funcs[0]->params) == 1);
  assert(mod->funcs[0]->params[0]->kind == IR_VAL_VAR);
  assert(strcmp(mod->funcs[0]->params[0]->name, "argc") == 0);
  assert(mod->funcs[0]->params[0]->ty->kind == IR_I32);
